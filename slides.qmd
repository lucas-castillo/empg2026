...
| [RECMH*]{.rn-fragment rn-type=highlight rn-color=yellow} | `sampler_mh(alpha=)` | ❌   | ❌   | ✅   |
| MCHMC                    | `sampler_mchmc()` | ✅   | ✅   | ❌   |
| [RECMC3*]{.rn-fragment rn-type=highlight rn-color=yellow} |`sampler_mc3(alpha=)` |  ✅   | ❌   | ✅   |
